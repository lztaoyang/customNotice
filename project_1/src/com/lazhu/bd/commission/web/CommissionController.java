package com.lazhu.bd.commission.web;
...
@RequestMapping(value = "bd/commission")
public class CommissionController extends BaseController<Commission> {
	...
	public Object get(ModelMap modelMap, @RequestBody Commission param) {
	...
	public Object update(ModelMap modelMap, @RequestBody Commission param) {
